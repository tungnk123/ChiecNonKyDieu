...
class LeaderboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Observe the playersList LiveData
        leaderboardViewModel.playersList.observe(this) { players ->
            players?.let {
                leaderboardAdapter.updateData(it)
            }
        }

        // Trigger the data fetch
        leaderboardViewModel.getAllPlayers()
    }
